...
func (*SaveRequest) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*SaveReply) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func init() { proto1.RegisterFile("saver.proto", fileDescriptor3) }
