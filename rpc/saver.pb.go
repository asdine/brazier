...
func init() {
	proto.RegisterType((*SaveRequest)(nil), "rpc.SaveRequest")
	proto.RegisterType((*SaveReply)(nil), "rpc.SaveReply")
}
...
func (c *saverClient) Save(ctx context.Context, in *SaveRequest, opts ...grpc.CallOption) (*SaveReply, error) {
	out := new(SaveReply)
	err := grpc.Invoke(ctx, "/rpc.Saver/Save", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	,
}
